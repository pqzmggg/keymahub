...
import com.keymahub.ble.BleHid
import com.keymahub.ble.HidSender
import com.keymahub.capture.A11yCapture
import com.keymahub.capture.HudOverlay
import com.keymahub.capture.PointerCaptureOverlay
import com.keymahub.core.Hotkey
import com.keymahub.core.Hub
import com.keymahub.ui.MainActivity
...
class HubService : Service(), BleHid.Listener {
    ...
    companion object {
        ...
        private const val ACTION_STOP = "com.keymahub.STOP"
        private const val ACTION_PAIR = "com.keymahub.PAIR"
