...
import dev.keymahub.poc.bt.ReportQueue
import dev.keymahub.poc.input.HidDescriptors.REPORT_ID_KEYBOARD
import dev.keymahub.poc.input.HidDescriptors.REPORT_ID_MOUSE
...
class ReportQueueTest {
    ...
    fun keysAndButtonsKeepOrderAndSplitMotion() {
        ...
        val press = mouse.setButton(Wire.BUTTON_LEFT, true)!!
        ...
        val release = mouse.setButton(Wire.BUTTON_LEFT, false)!!
    ...
    fun fullQueueNeverMovesMotionAcrossAClick() {
        ...
        q.push(REPORT_ID_MOUSE, move(1, 0))
        q.push(REPORT_ID_MOUSE, mouse.setButton(Wire.BUTTON_LEFT, true)!!)
        q.push(REPORT_ID_MOUSE, mouse.setButton(Wire.BUTTON_LEFT, false)!!)
        q.push(REPORT_ID_KEYBOARD, key(0x04))
