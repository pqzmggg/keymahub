...
import dev.keymahub.poc.host.A11yCapture
 ...
 */
class KeymahubAccessibilityService : AccessibilityService() {
    ...
    companion object {
        @Volatile
        var instance: KeymahubAccessibilityService? = null
            private set
    }
}
