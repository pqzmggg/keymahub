...
class ReceiverService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        started = true
        dev.keymahub.poc.bt.BtDiagnostics.register(this)
        startInForeground()
    ...
    private fun serve() {
        ...
        wifiLock = wifi.createWifiLock(mode, "keymahub:receiver").apply { acquire() }
    ...
    private fun startInForeground() {
        ...
        nm.createNotificationChannel(NotificationChannel(CHANNEL, "keymahub receiver", NotificationManager.IMPORTANCE_LOW))
        ...
        val n = Notification.Builder(this, CHANNEL)
            ...
            .setContentTitle("keymahub 리시버 실행 중")
    ...
    companion object {
        ...
        private const val ACTION_STOP = "dev.keymahub.poc.STOP"
