...
/**
 * HID keyboard usage (page 0x07) → Android `KeyEvent.KEYCODE_*`.
 * Used by the inject and accessibility backends; the UHID backend sends usages as-is.
 * Moves to the Rust keymap crate (via FFI) in P1.
 */
object HidKeycodes {
